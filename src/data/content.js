...
export const projects = [
  {
    ...
    image: null,
    detail: {
      intro: '一个记录代码与生活的小站，把汉堡配方和 bug 修复记在一起。',
      background: [
        '从大学第一年就想有一个自己的空间，把学到的、踩过的坑都写下来。',
        '选了自己最熟悉的 Vue 3 全家桶，从零搭起这个博客。'
      ],
      features: ['文章发布与标签分类', '代码高亮', '响应式阅读体验', '汉堡秘方专栏'],
      tech: ['Vue 3', 'Vite', 'Markdown', 'CSS']
    }
  }
]
...
export const interests = [
  {
    ...
    symbol: '◇',
    desc: '动起来才像话',
    image: '/src/assets/hobby-sport.jpg',
    items: ['羽毛球', '骑行', '台球', '乒乓球']
  },
  {
    name: '游戏',
    symbol: '▷',
    desc: '第二人生加载中',
    image: '/src/assets/hobby-game.jpg',
